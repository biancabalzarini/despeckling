...
% Disable font expansion to avoid pdfTeX errors with non-scalable fonts
\microtypesetup{expansion=false}

% Note: removed titlesec due to conflicts with llncs document class
% (previous attempts to reduce spacing caused package errors).
% If needed, tune spacing manually with \\vspace or class options.
...
%
\institute{Instituto Tecnológico de Buenos Aires, Buenos Aires, Argentina
...
supervised training, adequately modeling the statistical characteristics of actual speckle noise.
...
to actual SAR images. To address this problem, we explored training with pairs of actual images obtained through time
